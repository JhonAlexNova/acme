...
<?php
   ...
   require_once '../../app/controller/tipo_vehiculo/select.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" action='../../app/controller/vehiculo/insert.php' method='POST'>
                <div class="card-body">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="">Tipo de vehiculo <span class="text-danger">*</span></label>
                            <select name="tipo_vehiculo_id" class="form-control">
                                <option value="">Seleccionar</option>
                                  <?php
                                      if($query -> rowCount() > 0)   { ?>
                                          <?php  foreach($results as $result) {  ?>
                                            <option value="<?php echo $result->id;?>"> <?php echo $result->tipo; ?> </option>
                                          <?php  } ?>
                                    <?php  } ?>
                            </select>
                        </div>
                    ...
                    <!-- propietario -->
                    <div class="row" id='datos-propietario'>
                        <div class="col-md-12">
                            <h5>Datos del propietario</h5>
                          <hr>
                        </div>
                        <!-- campos usuario -->
                        <?php require_once '../conductores/campos.php'; ?>
                        <!-- end campos -->
...
<!-- ./wrapper -->
  ...
  <script>
    // /$('#datos-propietario label span').remove();
  </script>
</body>
</html>
